...
// Description : Modelling fractions: part 2
//============================================================================
...
int main(void) {
	...
	Fraction fadd = fraction1.plus(fraction2);
	Fraction fmin = fraction1.minus(fraction2);
	Fraction fmul = fraction1.times(fraction2);
	Fraction fdiv = fraction1.by(fraction2);



	//cout << fraction1.toString() << " is " << fraction1.toDouble() << " in decimal" << endl;

	cout << '\n';
	cout << fraction1.toString() << " + " << fraction2.toString() << " = " << fadd.toString() << endl;
	cout << fraction1.toString() << " - " << fraction2.toString() << " = " << fmin.toString() << endl;
	cout << fraction1.toString() << " * " << fraction2.toString() << " = " << fmul.toString() << endl;
	cout << fraction1.toString() << " / " << fraction2.toString() << " = " << fdiv.toString() << endl;
